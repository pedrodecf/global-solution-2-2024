    ...
    <Background className="bg-dark-green">
      ...
      <Section className="relative">
        ...
        <img
          src={circles}
          alt="circles"
          className="absolute left-1/2 transform -translate-x-1/2 bottom-0 no-drag max-h-[300px]"
        />
        <img
          src={widget1}
          alt=""
        ...
        <img
          src={widget4}
          alt=""
          className="max-w-[150px] absolute bottom-12 left-48 animate-float-4"
        />
        <img
          src={widget2}
          alt=""
        ...
        <img
          src={widget3}
          alt=""
          className="max-w-[250px] absolute bottom-12 right-28 animate-float-1"
        />
      </Section>
    </Background>
  );
